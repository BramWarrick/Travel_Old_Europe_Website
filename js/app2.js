...
// // To Do:
// Retrieve google maps json for places/location_types - found in temp.js
...
function createMarker(location, id, name) {
...
ko.applyBindings({
  category: [{
    ...
    link: "$parent.returnMarkers('churches')"
  }, {
    id: 3,
