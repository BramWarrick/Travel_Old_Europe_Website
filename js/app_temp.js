...
function initMap() {
  ...
  // Process found for best rending a styled map was found at
  ...
  // Loads the map, defaulting to the styled map but allowing
  // a roadmap or satellite view
  ...
  // for (var i = 0, church; church = churches.results[i]; i++) {
  //         addMarker(church.geometry.location);
  //       }
